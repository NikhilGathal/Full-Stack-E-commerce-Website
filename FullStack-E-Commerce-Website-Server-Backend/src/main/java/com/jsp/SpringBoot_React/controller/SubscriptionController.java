...
public class SubscriptionController {
    ...
    @DeleteMapping("/{email}")
    public String deleteSubscription(@PathVariable String email) {
        boolean isDeleted = service.deleteSubscription(email);
        return isDeleted ? "Subscription deleted successfully!" : "Email not found!";
    }
}
